...
export const generateSPRI = async (): Promise<string> => {
  const doc = new jsPDF();
...
// Judul tengah
doc.setFontSize(14);
doc.text("SURAT PERINTAH RAWAT INAP", pageWidth / 2, 14, { align: "center" });
doc.setFontSize(12);
doc.text("RSU Fastabiq Sehat PKU Muhammadiyah", pageWidth / 2, 20, { align: "center" });

doc.setFontSize(10);
const rightBlockX = pageWidth - 44; 
doc.text("No. SPRI/001/2025", rightBlockX, 14);
doc.text("Tgl. 08 Oktober 2025", rightBlockX, 20);
